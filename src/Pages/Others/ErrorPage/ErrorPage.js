...
const ErrorPage = () => {
  ...
  return (
    <section className="d-flex  align-items-center  vh-100 p-5   text-secondary">
      <div className="container d-flex flex-column align-items-center  justify-content-center px-5 mx-auto my-8">
        ...
        <div className="max-w-md  text-center">
          <h2 className=" text-danger">Error Status: {status}</h2>
          <p className=" text-danger mb-8">{statusText}</p>
